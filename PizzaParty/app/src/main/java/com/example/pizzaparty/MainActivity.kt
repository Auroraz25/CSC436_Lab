...
class MainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Log a debug message when onCreate is called
...
fun PizzaPartyScreen(modifier: Modifier = Modifier) {
    ...
    Column(
        ...
        Button(
            onClick = {
                val people = numPeopleInput.toIntOrNull() ?: 0
                totalPizzas = calculateNumPizzas(people, hungerLevel)
                Log.d("PizzaParty", "Calculated total pizzas: $totalPizzas for $people people with hunger level $hungerLevel")
            },
